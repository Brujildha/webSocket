...
socket.on('queue-ticket', (payload) => {
    ...
    if (ticket1) {
        ...
        lblDesk1.innerText = 'Ticket ' + ticket1.desk;
    }
    if (ticket2) {
        lblTicket2.innerText = 'Ticket ' + ticket2.number;
        lblDesk2.innerText = 'Ticket ' + ticket2.desk;
    }
    if (ticket3) {
        lblTicket3.innerText = 'Ticket ' + ticket3.number;
        lblDesk3.innerText = 'Ticket ' + ticket3.desk;
    }
    if (ticket4) {
        lblTicket4.innerText = 'Ticket ' + ticket4.number;
        lblDesk4.innerText = 'Ticket ' + ticket4.desk;
    }
});